...
{% blogpic "/img/blog-archive/back-1.jpg" "I said 'azure,' but that might be wrong.<br>...to be honest I have trouble with blue." %}

{% blogpic "/img/blog-archive/back-2.jpg" "It's hard to remember you're in a slump in a place like this" %}

{% blogpic "/img/blog-archive/back-3.jpg" "No matter where you go in the city, you will most likely have to walk uphill." %}

{% blogpic "/img/blog-archive/back-4.jpg" "The view from the highest point in the city." %}
